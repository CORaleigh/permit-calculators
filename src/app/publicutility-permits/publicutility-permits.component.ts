...
export class PublicutilityPermitsComponent implements OnInit {
  ...
  updateInfrastructureTotal() {
    ...
    this.sharedService.emitChange({total: this.capitalTotal + this.infrastructureTotal, calculator: 'publicutilties'});      
  ...
  raleighChanged(e) {
    if (!this.inRaleigh) {
      ...
      this.updateFee(null, 'Water Inspection', 1);
      this.updateFee(null, 'Sewer Inspection', 1);
      this.updateFee(null, 'Reuse Inspection', 1);
      this.updateFee(null, 'Water Stubs', 2);
      this.updateFee(null, 'Sewer Stubs', 2);
      this.updateFee(null, 'Reuse Stubs', 2);      
